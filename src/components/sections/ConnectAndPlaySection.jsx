      ...
      <div style={{ position: "relative", textAlign: "center", maxWidth: "900px", margin: "0 auto" }}>
        ...
        <FadeIn delay={0.1}>
          <div style={{ display: "flex", justifyContent: "center", marginBottom: "1.5rem" }}>
            <a href="#" style={{ display: "flex", alignItems: "center", gap: "0.75rem", background: "rgba(0,0,0,0.5)", border: "2px solid #ff0055", padding: "1rem 2.5rem", borderRadius: "4px", textDecoration: "none", fontFamily: t.fontDisplay, fontWeight: 800, fontSize: "1rem", color: "#c8b8ff", letterSpacing: "0.18em", backdropFilter: "blur(8px)", transition: "transform 0.2s, box-shadow 0.2s", boxShadow: "0 0 20px rgba(255,0,85,0.3)" }}
